...
## 2021-05-19 01:04:52 [Version 2.3.0]

Basetree version "20210613".

This release is the second part/chapter of the project.
Adds programs to build and validate trees containing well known hash functions.

Quick guide to building:

```sh
    # create system
    ./buildX X.json X.data
    # validate system
    ./validate X.json X.data
```
