...
struct build7bitCountContext_t {
	 ...
	 */
	void add(uint32_t *out, uint32_t *carryout, uint32_t left, uint32_t right, uint32_t carryin) {
		/*
		 * Reminder:
		 *  [ 2] a ? ~0 : b                  "+" OR
		 *  [ 6] a ? ~b : 0                  ">" GT
		...
		uint32_t leftORright = gTree->normaliseNode(left, IBIT, right);
		uint32_t leftXORright = gTree->normaliseNode(left, right ^ IBIT, right);
		uint32_t leftANDright = gTree->normaliseNode(left, right, 0);
	 ...
	 * Basic 7-bits adder
	 */
	void add7(uint32_t *O6, uint32_t *O5, uint32_t *O4, uint32_t *O3, uint32_t *O2, uint32_t *O1, uint32_t *O0,
		  uint32_t L6, uint32_t L5, uint32_t L4, uint32_t L3, uint32_t L2, uint32_t L1, uint32_t L0,
		  uint32_t R6, uint32_t R5, uint32_t R4, uint32_t R3, uint32_t R2, uint32_t R1, uint32_t R0) {

		// intermediate carries
		uint32_t C6, C5, C4, C3, C2, C1, C0;
