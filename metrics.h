...
static const metricsGenerator_t metricsGenerator[] = {
	...
	{9, 1, 5, 1286037101LL,    864907707, 0,      0}, // numCandidates takes about 15 minutes
	{9, 0, 5, 25583691074LL,   0,         0,      0},
	{9, 1, 6, 633200151789LL,  0,         0,      0}, // numProgress takes about 80 minutes
	{9, 0, 6, 1556055783374LL, 0,         0,      1}, // some historic value
	//
	{0}
};
